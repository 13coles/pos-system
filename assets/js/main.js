(function ($) {
    ...
    $('.small_product_wrapper').slick({
        ...
        arrows:true,
        rows: 4,
        prevArrow:'<button class="prev_arrow"><i class="bx bx-left-arrow" style="font-size: 13px !important;"></i></button>',
        nextArrow:'<button class="next_arrow"><i class="bx bx-right-arrow" style="font-size: 13px !important;"></i></button>', 
        responsive:[
            {
              breakpoint: 480,
              settings: {
    ...
    $('.single-product-active').on('changed.owl.carousel initialized.owl.carousel', function (event) {
        ...
        margin: 15,
        dots:false,
        navText: ['<i class="bx bx-left-arrow"></i>','<i class="bx bx-right-arrow"></i>'],
        responsiveClass:true,
		responsive:{
				0:{
				items:1,
    ...
    $('.recent_product_container').slick({
        ...
        rows: 4,
        prevArrow:'<button class="prev_arrow"><i class="bx bx-left-arrow" style="font-size: 13px !important;"></i></button>',
        nextArrow:'<button class="next_arrow"><i class="bx bx-righ-arrow" style="font-size: 13px !important;"></i></button>', 
        responsive:[
            {
              breakpoint: 480,
              settings: {
    ...
    /*---  ScrollUp Active ---*/
    $.scrollUp({
        scrollText: '<i class="bx bx-chevrons-up"></i>',
        easingType: 'linear',
        scrollSpeed: 900,
        animation: 'fade'
    });   
   ...
   /*---Newsletter Popup activation---*/
    ...
    $offcanvasNavSubMenu
      .parent()
      .prepend(
        '<span class="menu-expand"><i class="bx bx-down-arrow" style="font-size: 13px !important;"></i></span>'
      );
